...
var _user$project$Main$isDateLeet = function (date) {
	var minute = _elm_lang$core$Date$minute(date);
	var isMinute = _elm_lang$core$Native_Utils.eq(minute, 37);
	var hour = _elm_lang$core$Date$hour(date);
	var isHour = _elm_lang$core$Native_Utils.eq(hour, 13);
	return isHour && isMinute;
};
var _user$project$Main$view = function (model) {
	var date = _elm_lang$core$Date$fromTime(model);
	var isLeet = _user$project$Main$isDateLeet(date);
	var left = _user$project$Main$minutesLeft(date);
	var out = _elm_lang$core$String$concat(
		{
			ctor: '::',
			_0: _elm_lang$core$Basics$toString(isLeet),
			_1: {
				ctor: '::',
				_0: ' ',
				_1: {
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Is it 1337?'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
